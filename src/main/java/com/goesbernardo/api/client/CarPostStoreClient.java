package com.goesbernardo.api.client;
...
public class CarPostStoreClient {
    ...
    public void ownerPostsClient(OwnerPostDTO ownerPostDTO) {
        restTemplate.postForEntity(USER_STORE_SERVICE_URI, ownerPostDTO, OwnerPostDTO.class);
    }

    public void changeCarForSaleClient(CarPostDTO cardPostDTO, String id) {
        restTemplate.put(POSTS_STORE_SERVICE_URI + "/car" + id, cardPostDTO, CarPostDTO.class);
    }
